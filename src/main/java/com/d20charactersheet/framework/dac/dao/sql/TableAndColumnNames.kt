...
object TableAndColumnNames {
    ...
    /** Table of xp levels  */
    private const val TABLE_XP_LEVEL = "xp_level"
    ...
    private const val TABLE_KNOWN_SPELLS_TABLE = "known_spells_table"

    /** Table of levels of known spells  */
    private const val TABLE_KNOWN_SPELLS_LEVEL = "known_spells_level"

    /** Table of spells per day  */
    private const val TABLE_SPELLS_PER_DAY_TABLE = "spells_per_day_table"

    /** Table of levels of spells per day  */
    private const val TABLE_SPELLS_PER_DAY_LEVEL = "spells_per_day_level"
