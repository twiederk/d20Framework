 ...
 */
public class ImportReportComparator implements Comparator<ImportReport<?>>, Serializable {

  private static final long serialVersionUID = 1L;

  @Override
  public int compare(final ImportReport<?> report1, final ImportReport<?> report2) {
